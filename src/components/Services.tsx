        ...
        <div className="font-sans">
            ...
            <div className="sm:flex sm:gap-[36.5px] items-start mx-[32px] sm:justify-center">
                <div>
                    ...
                    <h2 className="text-[24px] font-bold leading-8 text-center text-[#252B42]">Easy Wins</h2>
                ...
                <div className="my-[30px] sm:my-0">
                    ...
                    <h2 className="text-[24px] font-bold leading-8 text-center text-[#252B42]">Concrete</h2>
                ...
                <div>
                    ...
                    <h2 className="text-[24px] font-bold leading-8 text-center text-[#252B42]">Hack Growth</h2>
